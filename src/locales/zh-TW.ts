export default {
  ...
  theme: {
    ...
    glassDynamicsModeVortex: '渦流',
    glassDynamicsModeOff: '關閉',
    glassDynamicsModeFluidHint: '跟隨指標形成連續的流動與折射回饋。',
    glassDynamicsModeVortexHint: '在指標附近形成局部旋轉，並沿經過路徑留下逐漸衰減的折射尾跡。',
  ...
  setting: {
    ...
    system: {
      ...
      musixmatchApiKeyHint: '選用；僅使用官方授權 API，請確認帳戶授權允許儲存和顯示歌詞',
      musixmatchBaseUrl: 'Musixmatch API 位址',
      musixmatchBaseUrlHint: '官方或已授權代理的 API 根位址',
