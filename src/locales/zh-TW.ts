export default {
  ...
  theme: {
    ...
    glassQualityBalancedHint: '表面內即時流動，優先平衡動態回饋與合成開銷。',
    glassQualityHighHint: '更通透的原生背板與更細的真實紋理位移，保留完整動態回饋。',
    glassBackdropDisplacementUnavailableHint: '目前瀏覽器使用原生靜態背板；動態參數已停用，材質參數仍然有效。',
    glassPreset: '方案',
    ...
    glassOpticalStrengthHint: '流動偏移控制紋理推進距離，形變強度控制真實背景位移，流動強度控制速度衰減與慣性。',
    glassOpticalStrengthUnavailableHint: '標準品質保留三項材質參數，切換到均衡或高品質後，可調整流動偏移、形變和流動。',
    purple: '幻紫',
    custom: '附加樣式',
    transparency: '透明度',
