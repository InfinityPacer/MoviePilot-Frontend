export default {
  ...
  subscribe: {
    ...
    maintenance: {
      ...
      searchAll: 'Search All Subscriptions',
      searchAllConfirmTitle: 'Search All Subscriptions?',
      searchAllConfirm:
        'The system will search every subscription available to your account in order and contact the relevant sites. This may take some time when you have many subscriptions. Continue?',
      searchAllStarted: 'All subscription searches are scheduled!',
      searchAllEmpty: 'There are no subscriptions to search',
      searchAllAlreadyRunning: '{count} subscriptions are already being searched',
      searchAllMixed: 'Scheduled {queued} subscriptions; {ongoing} are already in progress',
      searchAllScheduled: 'Scheduled {count} subscriptions; the system will search them in order',
