export default {
  ...
  theme: {
    ...
    transparencyPerformanceMode: 'Prefer performance',
    transparencyPerformanceModeHint: 'Pauses live glass blur, shadows, and card motion while applying background blur through a lighter image filter to reduce rendering load on dense pages.',
    transparencyPerformanceModeActive: 'Lightweight blur',
