export default {
  ...
  theme: {
    ...
    glassQualityBalancedHint: 'Surface-local live flow that balances dynamic feedback and compositing cost.',
    glassQualityHighHint: 'A clearer native backplate with finer real-texture displacement and full dynamic feedback.',
    glassBackdropDisplacementUnavailableHint:
      'This browser uses the native static backplate. Motion controls are disabled, while material controls remain active.',
    glassPreset: 'Preset',
    ...
    glassTranslationStrength: 'Flow Offset',
    ...
    glassOpticalStrengthHint:
      'Flow Offset controls texture travel. Deformation controls real backdrop displacement. Flow Strength controls velocity decay and inertia.',
    glassOpticalStrengthUnavailableHint:
      'Standard quality keeps all three material controls; switch to Balanced or High to adjust flow offset, deformation, and flow.',
    purple: 'Purple',
    custom: 'Custom Style',
