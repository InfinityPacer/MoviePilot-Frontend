export default {
  ...
  subscribe: {
    ...
    maintenance: {
      ...
      searchAllConfirm: '系统会依次搜索当前账号可访问的全部订阅，并访问相应站点。订阅较多时需要一些时间，是否继续？',
      searchAllStarted: '全部订阅搜索已安排！',
      searchAllEmpty: '没有需要搜索的订阅',
      searchAllAlreadyRunning: '{count} 个订阅已经在搜索中，请稍候',
      searchAllMixed: '已安排 {queued} 个订阅搜索，另有 {ongoing} 个正在处理中',
      searchAllScheduled: '已安排 {count} 个订阅，系统会自动依次搜索',
      refresh: '刷新订阅资源',
