export default {
  ...
  theme: {
    ...
    glassDynamicsModeVortex: '涡流',
    glassDynamicsModeOff: '关闭',
    glassDynamicsModeFluidHint: '跟随指针形成连续的流动与折射反馈。',
    glassDynamicsModeVortexHint: '在指针附近形成局部旋转，并沿经过路径留下逐渐衰减的折射尾迹。',
  ...
  setting: {
    ...
    system: {
      ...
      musixmatchApiKeyHint: '可选；仅使用官方授权 API，请确保账户授权允许保存和展示歌词',
      musixmatchBaseUrl: 'Musixmatch API 地址',
      musixmatchBaseUrlHint: '官方或已授权代理的 API 根地址',
