export default {
  ...
  theme: {
    ...
    glassQualityBalancedHint: '表面内实时流动，优先平衡动态反馈与合成开销。',
    glassQualityHighHint: '更通透的原生背板与更细的真实纹理位移，保留完整动态反馈。',
    glassBackdropDisplacementUnavailableHint: '当前浏览器使用原生静态背板；动态参数已停用，材质参数仍然有效。',
    glassPreset: '方案',
    ...
    glassOpticalStrengthHint: '流动偏移控制纹理推进距离，形变强度控制真实背景位移，流动强度控制速度衰减与惯性。',
    glassOpticalStrengthUnavailableHint: '标准质量保留三项材质参数，切换到均衡或高质量后，可调整流动偏移、形变和流动。',
    purple: '幻紫',
    custom: '附加样式',
    transparency: '透明度',
